# Mortgage Calculator API - Examples

This folder contains example code for using the Mortgage Calculator API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/mortgagecalculator',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/mortgagecalculator");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/mortgagecalculator](https://docs.apiverve.com/ref/mortgagecalculator)
